...
// Main canvas with 1280x720 pixels
// Open Source – CC BY 4.0
let board = new Board(1280, 720);
// Coordinate system: width 1100px, height 300px, horizontally centered at x=90
let coordSys = new CoordinateSystem(0, 1100, 300, 300, 0x444444, 20, 8, 1);
coordSys.x = 90;
coordSys.y = 360;
// Wave parameters
let A = 120; // Amplitude in pixels (maximum displacement)
let k = 0.02; // Wave number k = 2π/λ
let omega = 0.03; // Angular frequency ω = 2π/T
let phase = 0; // Current phase of the wave (continuously increased for animation)
let deltaTime = 1;
// Calculates wave points based on y(x,t) = A * sin(kx - ωt)
...
// Slider for amplitude A (value range 1-50)
...
// Slider for wave number k (slider value divided by 1000)
let sliderK = new ButtonSlider(5, 50, 20, 1, 50, 200);
sliderK.enableValueDisplay();
sliderK.setValueDisplayFont("Arial", 20);
sliderK.x = 450;
sliderK.y = 620;
let labelK = new Text("Wave number k", "Arial", 20, 0x333333, "left");
labelK.x = 450;
labelK.y = 590;
sliderK.onChange((e) => {
  k = e.value * 0.001;
