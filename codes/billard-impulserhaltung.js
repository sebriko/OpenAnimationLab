...
// Billard-Simulation zur Demonstration der Impulserhaltung
...
let friction = 0.018;
const MIN_VELOCITY = 0.15; // Schwellwert für Haftreibung - Kugeln stoppen wenn langsamer
const MASS = 1;
...
// Farbige Kugeln in Dreiecksformation
...
// Zielpfeil (rot, für die Stoßrichtung)
let aimArrow = new Arrow(0, 0, 100, 0, 0x222222, 2, 26, 12);
aimArrow.visible = false;

// ==================== UI ELEMENTE ====================

// Hinweistext – links oben
let hinweisText = new Text(
  "Drücken und ziehen Sie die Maustaste über dem weißen Kreis.",
  "Arial",
  22,
  0x666666,
);
...
// Buttons – rechts oben
let startButton = new Button("Stoß ausführen", 180, 40, "Arial", 22);
...
// Reibungs-Stepper – rechts unten
let frictionLabel = new Text("Rollreibung μ:", "Arial", 22, 0x333333);
frictionLabel.x = 1280 - 270 - 20;
...
timer.onUpdate(function () {
  ...
  for (let ball of balls) {
    ...
    // Haftreibung: Wenn Geschwindigkeit unter Schwellwert, Kugel stoppt sofort
    let speed = Math.sqrt(ball.vx * ball.vx + ball.vy * ball.vy);
    if (speed < MIN_VELOCITY) {
      ball.vx = 0;
      ball.vy = 0;
