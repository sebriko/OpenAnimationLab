...
// ═══════════════════════════════════════════════════════════════════
// RLC AC CIRCUIT: Impedance, Phase Shift and Resonance
// ═══════════════════════════════════════════════════════════════════
...
// ───────────────────────────────────────────────────────────────────
// HELPER FUNCTION: Decimal Formatting
// ───────────────────────────────────────────────────────────────────
...
let calcRes = new Text("Resonance: 112.5 Hz", "Arial", 22, colors.dark, "left");
calcRes.x = 1030;
calcRes.y = 205;
...
function updateCalculatedValues() {
  ...
  if (hasL && hasC && L > 0 && C > 0) {
    ...
    calcRes.setText("Resonance: " + fmt(fRes, 1) + " Hz");
...
function updateWaveforms() {
  ...
  // Check if the current maximum is within the visible time window
  if (tImax > T_TOTAL) {
  ...
  // Final visibility check: both maxima must be within [0, waveLength]
