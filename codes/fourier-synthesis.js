...
// ═══════════════════════════════════════════════════════════════════
// FOURIER SYNTHESIS: How Sine Waves Create Complex Shapes
// ═══════════════════════════════════════════════════════════════════
...
// Fourier coefficients depending on waveform
...
// ─────────────────────────────────────────────────────────────────
// CONTROLS – Play/Pause and Reset (bottom right)
// ─────────────────────────────────────────────────────────────────
...
// Circles and radius lines for epicycles
let circles = [];
let radiusMarkers = [];
...
// Connection line to the waveform
...
// Point at the end of the epicycles
...
// Coordinate system for the waveform
...
// Speed slider
let labelSpeed = new Text("Speed:", "Arial", 22, black, "right");
labelSpeed.x = 260;
labelSpeed.y = 640;
...
// ─────────────────────────────────────────────────────────────────
// Waveform Selection – RadioButtons
// ─────────────────────────────────────────────────────────────────
let labelWaveType = new Text("Waveform:", "Arial", 22, black, "left");
labelWaveType.x = 820;
labelWaveType.y = 545;
